...
function MainTabs() {
  ...
  return (
    <Tab.Navigator
      ...
      screenOptions={({ route }) => ({
        ...
        tabBarIcon: ({ color, size }) => {
          let iconName: string | undefined = 'home';
          if (route.name === 'Home') iconName = 'home';
          else if (route.name === 'Calendar') iconName = 'calendar';
          else if (route.name === 'Medications') iconName = 'medkit';
          else if (route.name === 'Caregiver') return <MaterialCommunityIcons name="account-heart" size={size} color={color} />;
    ...
    >
      <Tab.Screen name="Home" component={isCaregiver ? CaregiverHomeScreen : HomeScreen} options={{ title: 'Inicio' }} />
      <Tab.Screen name="Calendar" component={CalendarScreen} options={{ title: 'Calendario' }} />
      <Tab.Screen name="Medications" component={CaregiverMedicationsScreen} options={{ title: 'Medicamentos' }} />
      ...
      {isCaregiver && <Tab.Screen name="Caregiver" component={CaregiverDashboardScreen} options={{ title: 'Cuidador' }} />}
    </Tab.Navigator>
  );
}
